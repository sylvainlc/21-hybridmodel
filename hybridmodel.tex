...
$$
where $\{\varepsilon^n_{T+i}\}_{i\leqslant 1}$ are independent random variables with \textcolor{red}{specify here the right distribution} and $ U^n_T$ an unobserved regime switching Bernoulli random variable.
%$$
