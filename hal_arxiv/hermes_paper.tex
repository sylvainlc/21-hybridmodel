...
\rhead{Nonparametric general translation HMM}
...
\begin{figure}
\centering
  \includegraphics[width=1.\linewidth]{m4_nb_of_window}
  \includegraphics[width=1.\linewidth]{m4_batch_size}
  \includegraphics[width=1.\linewidth]{m4_learning_rate}
