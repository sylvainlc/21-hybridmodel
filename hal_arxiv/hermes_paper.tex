...
\author[$\dag$,*]{\'Etienne David}
\author[*]{Jean Bellot}
\author[$\dag$]{Sylvain Le Corff}


\affil[*]{{\small  Samovar, T\'el\'ecom SudParis,  D\'epartement CITI, Institut Polytechnique de Paris, France.}}
\affil[*]{{\small Heuritech, Paris, France.}}

\lhead{\'Etienne David, Jean Bellot, Sylvain Le Corff}
\rhead{HERMES Hybrid Error-corrector Model}
...
\begin{figure*}
\centering
  \includegraphics[width=\linewidth]{us_female_shoes}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{HERMES_archi.png}
...
\begin{figure*}
  \centering
    \includegraphics[width=1.\linewidth]{ff_example}
...
\begin{figure}
  \centering
    \includegraphics[width=0.8\linewidth]{lstm_archi}
...
\begin{figure}
  \includegraphics[width=.5\textwidth]{W10}
  \includegraphics[width=.5\textwidth]{W20}
  \includegraphics[width=0.5\textwidth]{W220}
  \includegraphics[width=0.5\textwidth]{W354}
\caption{Examples of time series from the M4 weekly dataset. From Top to Bottom, Left to Right : time series called \textit{W10} from the \textit{Other} category, \textit{W20} from the \textit{Macro} category, \textit{W220} from the \textit{Finance} category and \textit{W354} from the \textit{Micro} category.}
\label{fig:m4examples}
\end{figure}

\begin{figure*}
\centering
  \includegraphics[width=1.\linewidth]{W133_pred}
  \includegraphics[width=1.\linewidth]{W314_pred}
...
\begin{figure}
\centering
  \includegraphics[width=0.8\linewidth]{m4_nb_of_window}
  \includegraphics[width=0.8\linewidth]{m4_batch_size}
  \includegraphics[width=0.8\linewidth]{m4_learning_rate}
