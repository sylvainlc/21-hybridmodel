...
\textcolor{blue}{ok, cela me para\^it clair}
...
\begin{table}
  \caption{\textcolor{orange}{Results summary on 4 differents sub sample of  Fashion time series: i) disrupting time series, ii) stable time series, iii) seasonal time series and iv) noisy time series. Models with a $^*$ in their name have access to the influencers external signal.}}\vspace{0.5cm} 
 \centering
