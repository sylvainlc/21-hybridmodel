...
\textcolor{orange}{In this section, performance of the hybrid model are presented and compared with a several other approaches. the HERMES framework is evaluated on two different use cases.
\begin{itemize}
