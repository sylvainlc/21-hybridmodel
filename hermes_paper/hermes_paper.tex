...
Previous parameters was set with a grid search and our code is developed in Python using the Tensorflow library. It allows the use of a GPU to speed up the trainig process.
